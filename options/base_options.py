...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--run_on_cpu', action='store_true', help='Run entirely on CPU. useful for debugging.')
        self.parser.add_argument('--visdom_env', type=str, default='main', help='Which visdom environment to display results in.')
